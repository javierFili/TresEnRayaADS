...
class TresEnRaya {
    ...
    public void jugar(int fila, int colm) {
    ...
    public String toString() {
        if (hayTresEnRaya()) {
            return "Se tiene un ganador y ese es:  " + quienHaGanado();
        } else {
            if (estaLleno()) {
                return "El tablero esta lleno, por lo tanto, no existe ganador";
            }
